        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Propositions de mon equipe</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-lg-flex align-items-center mb-4 gap-3">
                <div class="position-relative">
                    <form action="{{ route('prod.indexByAgence') }}" method="get">
                        <select id="statusFilterByAgence" name="etape" class="form-select">
            ...
            <div class="table-responsive">
                ...
                <table class="table mb-0" id="example2">
                    ...
                    <tbody>
                        @forelse ($datas['allPropoFilteredByAgence'] as $item)
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                let statusSelect = document.getElementById('statusFilterByAgence');
