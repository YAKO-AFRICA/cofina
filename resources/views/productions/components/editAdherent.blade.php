<form action="{{ route('prod.adherent.update', $contrat->adherent->id)}}" method="post" class="submitForm">
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="naturepiece" id="carteconsulaire" value="carteconsulaire" autocomplete="on" required {{ $naturepiece === 'carteconsulaire' ? 'checked' : '' }}>
